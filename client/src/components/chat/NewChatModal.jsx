                    ...
                    >
                      {selectedUsers.map((user) => (
                        <motion.div
                          ...
                          className="flex items-center gap-2 rounded-full pl-2 pr-2 py-1"
                          style={{
                ...
                {!loading &&
                  results.map((user) => {
                    ...
                    return (
                      ...
                      >
                        {/* Avatar Layer with Custom Tap View Target */}
                        <div
                          className="w-11 h-11 rounded-full flex items-center justify-center font-bold shrink-0 overflow-hidden relative group transition-transform active:scale-95 shadow-sm"
                          style={{
                            background: P.goldGlow,
                            color: P.gold,
                            border: `1px solid ${P.goldDim}`,
                        ...
                        >
                          ...
                          {user.avatarUrl ? (
                            <img
                              src={user.avatarUrl.replace('/upload/', '/upload/q_100,f_auto/')}
                              alt={user.name}
          ...
          >
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-800 bg-zinc-950/50">
                <span className="text-zinc-300 font-semibold text-sm">Profile Preview</span>
                <button
                  onClick={() => setViewerImageUrl(null)}
