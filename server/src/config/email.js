...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.BREVO_SMTP_LOGIN,   // e.g. b24194001@smtp-brevo.com
    pass: process.env.BREVO_SMTP_PASSWORD, // your (rotated) SMTP key
  },
});
...
export const sendOTPEmail = async (email, otp, name) => {
  const mailOptions = {
    // Must be the exact email you verified as a Sender in Brevo's dashboard
    from: `"WorkSpace" <${process.env.BREVO_SENDER_EMAIL}>`,
    to: email,
