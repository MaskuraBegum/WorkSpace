              ...
              <table width="480" cellpadding="0" cellspacing="0" style="background:#141414;border-radius:20px;border:1px solid #2a2218;overflow:hidden;max-width:480px;width:100%;">
                ...
                <tr>
                  <td style="padding:36px 32px;">
                    ...
                    <p style="font-size:14px;color:#6b5e40;margin:0 0 28px;line-height:1.6;">
                    ...
                    <!-- OTP Box -->
                    <div style="background:#1a1a1a;border:1px solid #2a2218;border-radius:16px;padding:28px;text-align:center;margin-bottom:28px;">
                      <p style="font-size:11px;font-weight:700;color:#6b5e40;text-transform:uppercase;letter-spacing:2px;margin:0 0 16px;">
                      ...
                      <p style="font-size:12px;color:#3a3020;margin:16px 0 0;">
                        Expires in 10 minutes
                      </p>
                    </div>

                    <p style="font-size:13px;color:#4a4030;margin:0;line-height:1.6;">
                ...
                <tr>
                  <td style="padding:20px 32px;border-top:1px solid #2a2218;text-align:center;">
                    <p style="font-size:11px;color:#3a3020;margin:0;">
